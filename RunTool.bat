...
"%TOOL_PATH%" "C:\Users\Catalina\Desktop\Politehnica 2022 - 2026\Anul III\Sem II\PASSC\Lab\assignment_3\assignment_3\test_files\SimpleEventBus.dll" --format text --output "%OUTPUT_DIR%"

echo.
echo Processing file 5: SimpleEventBus.dll (Format: yuml)
"%TOOL_PATH%" "C:\Users\Catalina\Desktop\Politehnica 2022 - 2026\Anul III\Sem II\PASSC\Lab\assignment_3\assignment_3\test_files\SimpleEventBus.dll" --format yuml --output "%OUTPUT_DIR%"

echo.
echo Processing file 6: SimpleEventBus.dll (Format: plantuml)
"%TOOL_PATH%" "C:\Users\Catalina\Desktop\Politehnica 2022 - 2026\Anul III\Sem II\PASSC\Lab\assignment_3\assignment_3\test_files\SimpleEventBus.dll" --format plantuml --output "%OUTPUT_DIR%"

echo.
echo Processing file 7: SimpleEventBus2.dll (No methods, No attributes, Fully Qualified)
"%TOOL_PATH%" "C:\Users\Catalina\Desktop\Politehnica 2022 - 2026\Anul III\Sem II\PASSC\Lab\assignment_3\assignment_3\test_files\SimpleEventBus2.dll" --format plantuml --output "%OUTPUT_DIR%" --no-methods --no-attributes --fully-qualified

echo.
echo Processing file 8: SimpleEventBus2.dll (Ignore option: Subscription, IBasicEventBus)
"%TOOL_PATH%" "C:\Users\Catalina\Desktop\Politehnica 2022 - 2026\Anul III\Sem II\PASSC\Lab\assignment_3\assignment_3\test_files\SimpleEventBus2.dll" --format text --output "%OUTPUT_DIR%" --ignore "Subscription" --ignore "IBasicEventBus"
